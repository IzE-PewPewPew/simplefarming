...
RegisterNetEvent('qb-simplefarming:appletree', function()
  QBCore.Functions.Progressbar('apple_pickingapples', Config.Alerts['apple_pickingbar'], 3000 + math.random(1000,3000), false, true, {
    disableMovement = true,
    disableCarMovement = true,
    disableMouse = false,
    disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:milkcow', function()
  QBCore.Functions.TriggerCallback('qb-simplefarming:emptycowbucket', function(emptybucket)
    if emptybucket then
      ...
      QBCore.Functions.Progressbar('cow_milking', Config.Alerts['cow_milking'], 4000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
      disableMovement = true,
      disableCarMovement = true,
      disableMouse = false,
      disableCombat = true,
...
function GetBuckets()
  QBCore.Functions.Progressbar('dairy_processing', Config.Alerts['get_buckets'], Config.ProcessingTime['grab_cowbuckettime'] , false, true, { -- Name | Label | Time | useWhileDead | canCancel
  disableMovement = true,
  disableCarMovement = true,
  disableMouse = false,
  disableCombat = true,
...
RegisterNetEvent('qb-getcowbucket', function()
  QBCore.Functions.TriggerCallback('qb-simplefarming:hasbucket', function(hasItem)
      if hasItem then
        QBCore.Functions.Notify(Config.Alerts['error_hasbucket'], "error", 3000)
        --TriggerClientEvent('QBCore:Notify', source, "You can't carry more than one empty bucket!")
        return
...
RegisterNetEvent('qb-simplefarming:pumpkinfarming', function()
  ...
  QBCore.Functions.Progressbar("picking_pumpkins", Config.Alerts['picking_pumpkins'], 4000 + math.random(1000,3000), false, true, {
      disableMovement = true,
      disableCarMovement = true,
      disableMouse = false,
      disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:cornfield', function()
  QBCore.Functions.Progressbar("picking_corns", Config.Alerts['corn_picking'], 3000 + math.random(1000,3000), false, true, {
      disableMovement = true,
      disableCarMovement = true,
      disableMouse = false,
      disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:grapefield', function()
  ...
  QBCore.Functions.Progressbar("grapefield_picking", Config.Alerts['grape_picking'], 3000 + math.random(1000,3000), false, true, {
    disableMovement = true,
    disableCarMovement = true,
    disableMouse = false,
    disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:greenpepperfield', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("greenpepper_picking", Config.Alerts['greenpepper_picking'], 3000 + math.random(1000,3000),  false, true, {
    disableMovement = true,
    disableCarMovement = true,
    disableMouse = false,
    disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:chillfield', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("chilly_picking", Config.Alerts['chillypepper_picking'], 3000 + math.random(1000,3000), false, true, {
    disableMovement = true,
    disableCarMovement = true,
    disableMouse = false,
    disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:tomatoefields', function()
  TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic4"})
  QBCore.Functions.Progressbar("tomatoes_picking", Config.Alerts['tomatoes_picking'], 3000 + math.random(1000,3000), false, true, {
    disableMovement = true,
    disableCarMovement = true,
    disableMouse = false,
    disableCombat = true,
...
exports['qb-target']:AddBoxZone("barnfarmer", BarnSeller.targetZone, 1, 1, {
	name = "barnfarmer",
	heading = BarnSeller.targetHeading,
	debugPoly = true,
	minZ = BarnSeller.minZ,
	maxZ = BarnSeller.maxZ,
}, {
	options = {
    {
      type = "client",
      event = "qb-simplefarming:barnfarmer",
      icon = "fab fa-rocketchat",
      label = "Talk to Barn Owner",
    },
	},
	distance = 1.0
})

RegisterNetEvent('qb-qb-simplefarming:menubarn',function()
  local Owner = {
    {
      header = "Barn Menu",
      isMenuHeader = true,
    },
    {
      header = 'Rent A Knife',
      params = {
          event = 'qb-simplefarming:rentknife',
      }
    },
    {
      header = 'Sell Raw-Meats',
      params = {
          event = 'qb-simplefarming:rawmeatsell',
      }
    }
  }
end)
